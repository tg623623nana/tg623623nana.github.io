...
export const EmailIcon = ({ className, ...rest }) => (
  ...
  >
    <path 
    fill="currentColor"
    d="M65.5 68c-24.2 3.6-45.3 18.5-56.4 40-3.3 6.4-7.6 18-6.8 18.5C17.9 136.6 254.9 280.4 256 280.4c1.1 0 238.1-143.8 253.7-153.9.8-.5-3.5-12.1-6.8-18.5-9.5-18.4-25.8-31.7-46.9-38.2l-7.5-2.3-189-.1c-103.9-.1-191.3.2-194 .6z" />
    <path 
    fill="currentColor"
    d="M0 275c0 88.1.2 102.1 1.6 108.8 3.2 15.5 9.2 26.8 20.4 38.3 12.2 12.4 26.9 19.7 44.1 21.8 11.6 1.5 368.2 1.5 379.8 0 27-3.3 50.5-21.4 60.6-46.6 5.6-13.9 5.6-13.1 5.3-122.6l-.3-100.7-120 73.1c-66 40.3-122 74.1-124.3 75.1-5.9 2.7-16.5 2.7-22.4 0-2.3-1-57.6-34.4-122.7-74.1-65-39.7-119.2-72.6-120.2-73.2C0 174 0 176.1 0 275z" />
  </svg>
);
